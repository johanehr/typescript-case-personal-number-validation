const personalNumberRegex = new RegExp('^\d{6,8}[+-]\d{4}$'); // Naive regex for date of birth, since e.g. 20299999-1234 would pass. I suppose the + isn't valid for the yyyy format either.
